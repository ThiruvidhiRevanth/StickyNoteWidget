...
//   final lockFile = File('/tmp/sticky_note.lock');
...
//     const Color(0xFFF7EC8B), // Default yellow
...
//               );
//             }).toList()
//           : [quill.QuillController.basic()]; // Default note if empty

//       // Load colors, ensuring alignment with controllers
//       _noteColors = colorList.isNotEmpty
//           ? colorList.map((colorStr) => Color(int.parse(colorStr))).toList()
//           : [_availableColors[0]]; // Default color if empty

//       // Ensure _noteColors matches _controllers length
//       while (_noteColors.length < _controllers.length) {
//         _noteColors.add(_availableColors[0]);
//       }

//       // Reset _currentIndex to a valid value
//       _currentIndex = 0;
//     });
//   }
...
//       // Pick a random color from _availableColors
...
//   final List<Color> _availableColors = [
//     Colors.yellow.shade400,// Default yellow
//     Colors.lightBlue.shade100,
//     Colors.pink.shade100,
//     Colors.green.shade100,
//     Colors.orange.shade100,
